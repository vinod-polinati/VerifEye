...
sgd_pipeline = Pipeline([
    ...
    ('svm2_clf', SGDClassifier(loss='hinge', penalty='l2', alpha=1e-3, max_iter=10))
])
...
accuracy_sgd = np.mean(predicted_sgd == DataPrep.test_news['Label'])
...
print(classification_report(DataPrep.test_news['Label'], predicted_sgd))
...
plot_learing_curve(sgd_pipeline,"SGD Classifier")
...
show_most_informative_features(sgd_pipeline,vect='sgd_tfidf',clf='sgd_clf')
