...
# Set SSL to not verify certificates
...
nltk.data.path.append("/Users/chaitu/nltk_data")
nltk.download('treebank', download_dir="/Users/chaitu/nltk_data")
...
#Using Word2Vec 
with open("/Users/chaitu/Downloads/Fake_News_Detection-master/glove.6B.50d.txt", "rb") as lines:
